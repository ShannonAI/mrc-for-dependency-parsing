...
DATA_DIR="/yuxian/data/parser/ud-treebanks/ud-treebanks-v2.2/merged_dataset/czech"
...
for LR in 6e-5 8e-5 4e-5 2e-5 1e-6 3e-6 5e-6; do
    ...
    # save directory
    OUTPUT_DIR="/userhome/ganleilei/train_logs/dependency/ud-cs/biaf/finetune/lr${LR}_accumulate${accumulate}_warmup${WARMUP}_add${addition}"
    mkdir -p $OUTPUT_DIR
