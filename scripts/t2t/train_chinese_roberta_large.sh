...
OUTPUT_DIR="train_logs/dependency/ctb/t2t/${TIME_DIR}/finetune/roberta_large_newsep_newfc_wchild_finetune_${LAYER}l_lr${LR}_dropout${MRC_DROPOUT}_bs2560_warmup${WARMUP}_newinit"
